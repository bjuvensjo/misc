require([ "jquery", "pingpong/court", "pingpong/racket", "pingpong/ball", "pingpong/vector2d" ],
    function($, court, racket, ball, vector2d) {
        ...
        serve = function() {
            ...
            intervalId = setInterval(function() {
                ...
                if (theBall.getY() + theBall.getR() >= theRacket.getY()
                        && (theBall.getX() + theBall.getR() < theRacket.getX() || theBall.getX() - theBall.getR() > theRacket.getX()
                                + theRacket.getW())) {
                    // racket missed ball
