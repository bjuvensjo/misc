define(['../../util/combination', '../../util/index', '../../util/BitSet'], function(combinationUtil, indexUtil, Set) {
                ...
                for (n = 2; n < notesValues.length; n++) {
                    ...
                    for (i = 0; i < possibleNotesCombinations.length; i++) {
                        ...
                        for (j = 0; j < indexes.length; j++) {
                            ...
                            if (cellNotes !== null) {
                                if (countNotesContainingSomeCombinationValue === 0) { // performance reasons
